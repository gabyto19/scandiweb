...
<head>
    ...
    <script type="text/javascript" src="insert-product.php"></script>
</head>
    ...
    <div id="app">
        <nav>
            ...
            <div class="rightButtons">
                <button @click="submitForm();clearIt();">Save</button>
                <button class="delete-checkbox" id="delete-product-btn">
